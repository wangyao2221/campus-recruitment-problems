 ...
 */
public class Main5New {
    private static Stack<Character> cStack = new Stack<Character>();
    ...
    // (7+3)*4
    // 返回str的表达式的值
    public static int calc(char[] exp) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(calc((sc.nextLine() + ")").toCharArray()));
    }
}
